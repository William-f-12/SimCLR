# a module for loading the STL-10 dataset
# Credit to:
# @uthor: Martin Tutek
# github repo: https://github.com/mttk/STL10
...
UNLABEL_PATH = DATA_DIR + 'stl10_binary/unlabeled_X.bin'
...
if __name__ == "__main__":
    ...
    unlabel_images = read_all_images(UNLABEL_PATH)
    save_unlabeled_images(unlabel_images)
